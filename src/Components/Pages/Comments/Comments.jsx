...
function Comments() {
  ...
  const {
    REACT_APP_BASE_URL,
    REACT_APP_POSTS_PARAM,
    REACT_APP_COMMENTS_PARAM,
  } = process.env;
  useEffect(() => {
    ...
    if (comments) {
      ...
      axios
        .get(
          `${REACT_APP_BASE_URL}/${REACT_APP_POSTS_PARAM}/${id}/${REACT_APP_COMMENTS_PARAM}`
        )
  ...
  return (
    <>
      ...
      <div className="row row-cols-6 mt-5 mx-4 g-4">
